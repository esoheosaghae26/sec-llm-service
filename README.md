...
The project is divided into several stages, each building upon the previous one:

SEC CIK Lookup Module: Build a Python library that maps a company's name or stock ticker to its Central Index Key (CIK), which uniquely identifies companies in the SEC EDGAR database.
